...
window.onload = function() {
    ...
    //             function (tx, results) {
    //                 // SUCCESS
    //                 const bookbase = document.getElementById("base"); 
    //                 const booklist = document.createElement("ul"); 
    //                 bookbase.appendChild(booklist); 
        
    //                 for (let i = 0; i < results.rows.length; i++){
    //                     console.log(results.rows.item(i).author)
    //                     console.log(results.rows.item(i).title)
    //                     const book = `${results.rows.item(i).author}, ${results.rows.item(i).title}`
